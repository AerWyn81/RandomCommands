package fr.aerwyn81.randomcommands.utils.message.color;

import com.google.common.collect.ImmutableMap;
import fr.aerwyn81.randomcommands.utils.message.color.patterns.*;
...
public class IridiumColorAPI {
     ...
     * @since 1.0.2
     */
    private static final List<Pattern> PATTERNS = Arrays.asList(new GradientPattern(), new SolidPattern(), new RainbowPattern(), new RCPattern());
